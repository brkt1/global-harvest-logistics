          ...
          <div className="py-16 md:py-20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              ...
              <div className="sm:col-span-2 lg:col-span-1">
                <Link href="/" className="flex items-center space-x-3 mb-6 md:mb-8 group">
                  <div className="bg-gradient-to-br from-ghl-secondary-400 to-ghl-secondary-600 p-3 rounded-xl group-hover:from-ghl-secondary-500 group-hover:to-ghl-secondary-700 transition-all duration-300 shadow-lg group-hover:shadow-xl group-hover:scale-105">
                    <Truck className="h-6 w-6 md:h-8 md:w-8 text-white" />
                  </div>
                  <div>
                    <h3 className="text-xl md:text-2xl font-heading font-bold text-white">Global Harvest</h3>
                    <p className="text-sm text-white/70 font-medium">Logistics</p>
                  </div>
                </Link>
                ...
                <div className="flex space-x-3">
                  <a href="#" className="text-white/60 hover:text-white hover:bg-white/10 transition-all duration-300 p-3 rounded-xl backdrop-blur-sm border border-white/20 hover:border-white/30 hover:scale-110">
