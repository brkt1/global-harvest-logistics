  ...
  const sesameProducts = [
    {
      ...
      description:
        "The crown jewel of Ethiopian sesame exports, known for its large white seeds, high oil content, and distinctive sweet aroma. Grown in the fertile Humera region, this variety commands premium prices in international markets.",
      features: [
    ...
    },
    {
      ...
      description:
        "Premium quality sesame from the Wollega region, available in both white and brown seed varieties. Known for excellent purity, consistent quality, and versatile applications across food industries.",
      features: [
  ...
  const pulsesAndBeans = [
    {
      ...
      description:
        "Characterized by its deep red color and excellent cooking quality, our Red Kidney Beans are rich in protein, fiber, and essential nutrients. They maintain their shape and texture well in various culinary applications.",
      features: [
    ...
    },
    {
      ...
      description:
        "Featuring a creamy white color and uniform size, White Pea Beans are versatile legumes ideal for traditional dishes, soups, and various food processing applications. Known for their mild flavor and smooth texture.",
      features: [
    ...
    },
    {
      ...
      description:
        "Distinguished by their unique speckled appearance and firm texture, these beans offer excellent nutritional value and visual appeal. Their robust flavor makes them ideal for hearty dishes and traditional recipes.",
      features: [
    ...
    },
    {
      ...
      description:
        "High-protein soya beans suitable for both food consumption and industrial applications. Our soya beans meet quality standards for tofu production, animal feed, and various processed food products.",
      features: [
        ...
        <div className="container-custom">
          <div className="text-center mb-16 sm:mb-20 lg:mb-24">
            <div className="inline-flex items-center px-4 py-2 sm:px-5 sm:py-2.5 bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 text-white rounded-full text-xs sm:text-sm lg:text-base font-semibold mb-6 sm:mb-8 shadow-lg">
              ...
              <EditableText content="Our Premium Services" contentKey="services-section-badge" tag="span" />
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-heading font-bold text-gray-900 mb-4 sm:mb-6 lg:mb-8">
              <span className="block">
                <EditableText content="Why People Choose" contentKey="services-section-title-1" tag="span" />
              </span>
              <span className="block bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 bg-clip-text text-transparent">
                <EditableText content="Our Services" contentKey="services-section-title-2" tag="span" />
              </span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
            {services.map((service, index) => (
              <Link key={service.id} href={`/services/${service.id}`} className="group relative block">
                ...
                <div className="relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden group">
                  ...
                  {service.imageURL && (
                    <div className="relative h-48 sm:h-56 lg:h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <span
                          className={`inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-white/90 backdrop-blur-sm text-white rounded-full text-xs sm:text-sm font-semibold shadow-lg`}
                        >
                          <service.icon className="h-4 w-4 sm:h-5 sm:w-5 mr-2 text-gray-800" />
                          <EditableText
                      ...
                      <div className="absolute bottom-4 right-4">
                        <div
                          className={`w-12 h-12 sm:w-14 sm:h-14 bg-white/90 backdrop-blur-sm rounded-full shadow-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                        >
                          <service.icon className={`h-6 w-6 sm:h-7 sm:w-7`} style={{ color: "#059669" }} />
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="p-6 sm:p-8 lg:p-10 relative z-10">
                    ...
                    <div className="relative z-10 mb-4 sm:mb-6">
                      <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3 group-hover:text-ghl-primary-600 transition-colors">
                        <EditableText content={service.title} contentKey={`service-${service.id}-title`} tag="span" />
                      </h3>
                    ...
                    {/* Key Features */}
                    <div className="relative z-10 mb-4 sm:mb-6">
                      <h4 className="text-xs sm:text-sm font-semibold text-gray-500 uppercase tracking-wide mb-3 sm:mb-4">
                        <EditableText
                    ...
                    <div className="relative z-10">
                      <div className={`bg-gradient-to-r ${service.gradient} rounded-xl p-4 sm:p-5 lg:p-6 text-white`}>
                        <div className="flex items-center mb-2 sm:mb-3">
                          <Star className="h-4 w-4 sm:h-5 sm:w-5 text-yellow-300 mr-2" />
                    ...
                    <div className="relative z-10 mt-4 sm:mt-6">
                      <div
                        className={`w-full bg-white border-2 border-gray-300 text-gray-900 py-3 sm:py-4 px-4 sm:px-6 rounded-xl font-semibold flex items-center justify-center gap-2 group-hover:scale-105 group-hover:border-ghl-primary-600 group-hover:text-ghl-primary-600 transition-all duration-300 shadow-md group-hover:shadow-xl`}
                      >
                        View Details
                ...
                <div
                  className="absolute -bottom-2 -left-2 w-4 h-4 bg-gradient-to-r from-ghl-secondary-400 to-ghl-primary-500 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 "
          ...
          <div className="mt-16 sm:mt-20 lg:mt-24 text-center">
            <div className="bg-white rounded-2xl sm:rounded-3xl p-8 sm:p-10 lg:p-12 shadow-lg border border-gray-100">
              <EditableText
                content="Why People Love Our Services"
                contentKey="services-trust-title"
                tag="h3"
                className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-8 sm:mb-10 lg:mb-12"
              />
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gray-100 text-gray-800 rounded-full text-sm font-semibold mb-8 shadow-lg border border-gray-200">
              ...
              <EditableText content="Our Proven Process" contentKey="services-process-badge" tag="span" />
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-lg border border-gray-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center group">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    <EditableText content="On-Time Delivery" contentKey="services-process-benefit-2-title" tag="span" />
                  </h4>
                  <p className="text-sm text-gray-600">
                    <EditableText
                ...
                <div className="text-center group">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    <EditableText content="Expert Support" contentKey="services-process-benefit-3-title" tag="span" />
                  </h4>
                  <p className="text-sm text-gray-600">
                    <EditableText
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 text-white rounded-full text-sm font-semibold mb-8 shadow-lg">
              ...
              <EditableText content="Our Advanced Capabilities" contentKey="services-capabilities-badge" tag="span" />
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-gray-900 mb-6">
              <span className="block">
                <EditableText content="Technology That" contentKey="services-capabilities-title-1" tag="span" />
              </span>
              <span className="block bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 bg-clip-text text-transparent">
                <EditableText content="Delivers Excellence" contentKey="services-capabilities-title-2" tag="span" />
              </span>
            </h2>
            ...
            {capabilities.map((capability, index) => (
              <div key={index} className="group">
                ...
                <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 h-full flex flex-col">
                  ...
                  <div className="mb-4">
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r ${capability.gradient} rounded-xl shadow-md`}
                    >
          ...
          <div className="mt-16">
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  <EditableText content="Our Technology Advantage" contentKey="services-tech-title" tag="span" />
                </h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 mb-1">
                    <EditableText content="Real-time" contentKey="services-tech-stat-1-value" tag="span" />
                  </div>
                  <div className="text-sm text-gray-600">
                    <EditableText content="Temperature Monitoring" contentKey="services-tech-stat-1-label" tag="span" />
                  </div>
                </div>
                <div className="text-center p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 mb-1">
                    <EditableText content="ISO 9001" contentKey="services-tech-stat-2-value" tag="span" />
                  </div>
                  <div className="text-sm text-gray-600">
                    <EditableText content="Quality Certified" contentKey="services-tech-stat-2-label" tag="span" />
                  </div>
                </div>
                <div className="text-center p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 mb-1">
                    <EditableText content="Eco-Friendly" contentKey="services-tech-stat-3-value" tag="span" />
                  </div>
                  <div className="text-sm text-gray-600">
                    <EditableText content="Sustainable Practices" contentKey="services-tech-stat-3-label" tag="span" />
                  </div>
                </div>
                <div className="text-center p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                  ...
                  <div className="text-lg font-bold text-gray-900 mb-1">
                    <EditableText content="24/7" contentKey="services-tech-stat-4-value" tag="span" />
                  </div>
                  <div className="text-sm text-gray-600">
                    <EditableText content="Monitoring" contentKey="services-tech-stat-4-label" tag="span" />
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-custom relative z-10">
          <div className="text-center mb-20">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 text-white rounded-full text-sm font-semibold mb-8 shadow-lg">
              ...
              <EditableText content="Our Import Services" contentKey="imports-badge" tag="span" />
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-gray-900 mb-6">
              <span className="block">
                <EditableText content="Our Import Services" contentKey="imports-title-1" tag="span" />
              </span>
              <span className="block bg-gradient-to-r from-ghl-primary-600 to-ghl-secondary-400 bg-clip-text text-transparent">
                <EditableText
          ...
          <div className="mb-20">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-12 text-center">
              <EditableText content="Product Categories We Import" contentKey="imports-categories-title" tag="span" />
            </h3>
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl px-4 py-2 shadow-lg">
                      <h4 className="text-lg font-bold text-gray-900">
                        <EditableText content="Electric Automobiles" contentKey="imports-category-2-title" tag="span" />
                      </h4>
                    </div>
                  </div>
                </div>
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="bg-white/90 backdrop-blur-sm rounded-xl px-4 py-2 shadow-lg">
                      <h4 className="text-lg font-bold text-gray-900">
                        <EditableText content="Industrial Chemicals" contentKey="imports-category-3-title" tag="span" />
                      </h4>
                    </div>
                  </div>
                </div>
          ...
          <div className="mb-20">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-12 text-center">
              <EditableText content="How We Work" contentKey="imports-how-we-work-title" tag="span" />
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Step 1 */}
              ...
              <div className="group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-200">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-4 text-center lg:text-left group-hover:text-ghl-primary-600 transition-colors">
                  <EditableText content="Local Distribution Support" contentKey="imports-step-4-title" tag="span" />
                </h4>
                <p className="text-gray-600 text-sm leading-relaxed text-center lg:text-left">
                  <EditableText
          ...
          <div className="relative bg-gradient-to-br from-ghl-primary-50 to-ghl-secondary-50 rounded-3xl p-8 md:p-12 shadow-2xl border-2 border-gradient-to-r from-ghl-primary-200 to-ghl-secondary-200 overflow-hidden">
            ...
            <div
              ...
              style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fillRule='evenodd'%3E%3Cg fill='%23000000' fillOpacity='0.08'%3E%3Cpath d='M30 30c0-8.3-6.7-15-15-15s-15 6.7-15 15 6.7 15 15 15 15-6.7 15-15zm15 0c0-8.3-6.7-15-15-15s-15 6.7-15 15 6.7 15 15 15 15-6.7 15-15z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
              }}
            ></div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex items-start group bg-white/50 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">
                      <EditableText content="Trusted Global Network" contentKey="imports-why-1-title" tag="span" />
                    </h4>
                ...
                <div className="flex items-start group bg-white/50 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">
                      <EditableText content="Compliance Expertise" contentKey="imports-why-2-title" tag="span" />
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      <EditableText
                ...
                <div className="flex items-start group bg-white/50 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">
                      <EditableText content="Competitive Pricing" contentKey="imports-why-3-title" tag="span" />
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      <EditableText
                ...
                <div className="flex items-start group bg-white/50 backdrop-blur-sm rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-gray-900 mb-2 text-lg">
                      <EditableText content="Reliability" contentKey="imports-why-4-title" tag="span" />
                    </h4>
                    <p className="text-gray-700 text-sm leading-relaxed">
                      <EditableText
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-600 to-green-800 text-white rounded-full text-sm font-semibold mb-8 shadow-lg">
              <Truck className="w-5 h-5 mr-3" />
              <EditableText content="Shipping Information" contentKey="shipping-badge" tag="span" />
            </div>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-gray-900 mb-6">
              <span className="block bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">
                <EditableText content="Reliable Export Logistics" contentKey="shipping-title" tag="span" />
              </span>
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              <EditableText
          ...
          <div className="mb-16">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6 text-center">
              <EditableText content="International Markets" contentKey="shipping-markets-title" tag="span" />
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-ghl-primary-600 transition-colors">
                    <EditableText content="Asia" contentKey="shipping-market-asia-title" tag="span" />
                  </h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    <EditableText
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-ghl-primary-600 transition-colors">
                    <EditableText content="Middle East & Africa" contentKey="shipping-market-mena-title" tag="span" />
                  </h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    <EditableText
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-ghl-primary-600 transition-colors">
                    <EditableText content="Europe" contentKey="shipping-market-europe-title" tag="span" />
                  </h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    <EditableText
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-ghl-primary-600 transition-colors">
                    <EditableText content="Global Reach" contentKey="shipping-market-global-title" tag="span" />
                  </h4>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    <EditableText
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8 md:p-12 border-2 border-green-200">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              <EditableText content="Quality You Can Trust" contentKey="shipping-quality-title" tag="span" />
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  <CheckCircle className="h-6 w-6 text-green-600 mr-3" />
                  <EditableText content="Strict Quality Control" contentKey="shipping-quality-1-title" tag="span" />
                </h4>
              ...
              <div>
                <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  ...
                  <EditableText content="Complete Documentation" contentKey="shipping-quality-2-title" tag="span" />
                </h4>
                <p className="text-gray-700 leading-relaxed">
                  <EditableText
          ...
          <div className="py-16 sm:py-20 lg:py-24">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                ...
                >
                  <EditableText content="Get Quote" contentKey="services-cta-secondary-button-text" tag="span" />
                </Link>
              </div>
